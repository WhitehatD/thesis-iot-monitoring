...
export default function SchedulerPanel() {
    ...
    const resetForm = () => {
        setFormName("");
        setFormDesc("");
        setFormTasks([{ time: "09:00:00", action: "CAPTURE_IMAGE", objective: "" }]);
        setShowForm(false);
    };
    ...
    const toggleSleep = async () => {
        ...
        try {
            const res = await fetch(`${apiBase}/api/schedules/sleep-mode?enabled=${newState}`, {
                method: "POST",
            });
        ...
        <div className="scheduler-panel">
            ...
            <div className="scheduler-toolbar">
                ...
                <button
                    ...
                    title={sleepEnabled ? "Board sleeps between tasks" : "Board stays awake"}
                >
                    {togglingleep ? (
